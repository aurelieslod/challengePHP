...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <!-- Contact form -->
                <form  enctype="multipart/form-data" name="sentMessage" action="../form.php" id="contactForm" method="post">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" name="birthday" id="birthday" required data-validation-required-message="Please enter your birthday.">
                            <p class="help-block"></p>
                        </div>
                    </div>
                    <div class="control-group form-group">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Game :</label>
                            <input type="text" class="form-control" name="game" id="game" required data-validation-required-message="Please enter your game.">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
